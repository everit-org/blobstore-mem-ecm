 ...
 */
package org.everit.blobstore.mem.ecm.tests;
 ...
 */
@ExtendComponent
@Component(componentId = "MemBlobstoreComponentTest")
@StringAttributes({
    ...
    @StringAttribute(attributeId = TestRunnerConstants.SERVICE_PROPERTY_TEST_ID,
        defaultValue = "memBlobstoreComponentTest") })
@Service(MemBlobstoreComponentTest.class)
public class MemBlobstoreComponentTest {
